<h1>End of Module Assignment<h2/>
...
<h2>Describe of the solution<h2/>

<h4>Built in Python, this solution shows the safe management of user credentials together with the application of Role-Based Access Control (RBAC). Essential components consist:
...
Though basic, this solution shows sound programming techniques and basic cybersecurity protections and provides a safe basis to grow on<h4/>


<h2> Instructions to Execute<h2/>
Prerequisites
...
<h2>the outcome<h2/>
<h4>Customer 'alice' registered successfully.
...
•	carol (Admin) logged in and managed user accounts.<h4/>
